...
try {
		...
		cout << "Enter expressions using floats" << endl;
		cout << "You can use +, -, /, *, and brackets" << endl;
		cout << "Define your own names using '' let 'character' = 'number' ''"<< endl;
		cout << "Calculate by typing a ';' at the end of your expression" << endl; 
		cout << "Exit by typing 'exit'" << endl << endl;
		calculate();
		return 0;
	}
	catch (exception& e) {
